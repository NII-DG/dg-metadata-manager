...
class TestDefinitionManager():
    ...
    def test_get_and_filter_mapping_definition_1(self, mocker):
        ...
        mock__read_mapping_definition = mocker.patch(
            ...
            return_value=TestDefinitionManager.test_mapping_definition )
        ...
        assert mapping_definition == TestDefinitionManager.test_mapping_definition
    ...
    def test_get_and_filter_mapping_definition_8(self, mocker):
    ...
    def test__read_mapping_definition_1(self, create_dummy_definition):
        """@pytest.fixtureを用いたサンプルのテストケースです。"""

        with pytest.raises(MappingDefinitionError):#エラーになるので修正しました。
            # テスト実行
            target_class = DefinitionManager()
            target_class._read_mapping_definition(*create_dummy_definition)

    def test__read_mapping_definition_2(self, create_test_definition):
    ...
    def test__read_mapping_definition_4(self, create_invalid_test_definition):
